...
class MainUI(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.title("Anti-Theft Ai System")
...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        render = PhotoImage(file='img.png')
        img = tk.Label(self, image=render,pady=0, padx=0, borderwidth=0, highlightthickness = 0)
        img.image = render
        img.grid(row=0, column=1, rowspan=4, sticky="nsew")
        label = tk.Label(self, text="        Start Anti-Theft AI       ", bg='black', font=self.controller.title_font,
                         fg="#ffffff")
        label.grid(row=0, sticky="ew")
        button1 = tk.Button(self, text="   Add a User  ", fg="#ffffff", bg="gray22",
                            command=lambda: self.controller.show_frame("PageOne"))
        button2 = tk.Button(self, text="   Start  ", fg="#ffffff", bg="gray22",
                            command=lambda: self.controller.show_frame("PageTwo"))
        button3 = tk.Button(self, text="Quit", fg="gray20", bg="#ffffff", command=self.on_closing)
...
class PageOne(tk.Frame):
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent)
        self.controller = controller
        tk.Label(self, text="Enter the name", fg="#ffffff", bg="black",font='Helvetica 12 bold').grid(row=0, column=0, pady=10,
                                                                                           padx=5)
        ...
        self.buttoncanc = tk.Button(self, text="Cancel", bg="#ffffff", fg="gray20",
                                    command=lambda: controller.show_frame("StartPage"))
        self.buttonext = tk.Button(self, text="Next", fg="#ffffff", bg="gray22", command=self.start_training)
...
class PageTwo(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        global names
        self.controller = controller
        tk.Label(self, text="Select user", fg="#ffffff",bg="black", font='Helvetica 12 bold').grid(row=0, column=0, padx=10,
                                                                                        pady=10)
        ...
        self.buttonext = tk.Button(self, text="Next", command=self.nextfoo, fg="#ffffff", bg="gray22")
...
class PageThree(tk.Frame):
    ...
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent)
        self.controller = controller
        self.numimglabel = tk.Label(self, text="Number of images captured = 0", font='Helvetica 12 bold', fg="#ffffff",bg="black")
        self.numimglabel.grid(row=0, column=0, columnspan=2, sticky="ew", pady=10)
        self.capturebutton = tk.Button(self, text="Capture Data Set", fg="#ffffff", bg="gray22", command=self.capimg)
        self.trainbutton = tk.Button(self, text="Train The Model", fg="#ffffff", bg="gray22", command=self.trainmodel)
    ...
    def capimg(self):
        ...
        messagebox.showinfo("INSTRUCTIONS", "We will Capture 500 pic of your Face.")
        x = start_capture(self.controller.active_name)
        self.controller.num_of_images = x
        self.numimglabel.config(text=str("Number of images captured = " + str(x)))

    def trainmodel(self):
        if self.controller.num_of_images < 500:
            messagebox.showerror("ERROR", "No enough Data, Capture at least 500 images!")
            return
...
class PageFour(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="Start The System", font='Helvetica 16 bold',fg="#ffffff",bg="black")
        label.grid(row=0, column=0, sticky="ew")
        button1 = tk.Button(self, text="ON ATA", command=self.openwebcam, fg="lawn green", bg="gray22")
        ...
        button4 = tk.Button(self, text=" Back To Home ", command=lambda: self.controller.show_frame("StartPage"),
                            bg="#ffffff", fg="gray20")
...
app = MainUI()
app.iconphoto(False, tk.PhotoImage(file='img.png'))
app.mainloop()
